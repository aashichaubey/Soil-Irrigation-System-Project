...
int main(void)
{
  ...
  while (1)
  {
  	  digit_A = count % 10;   // ones digit
  	  digit_B = count / 10;   // tens digit

  	  DIGITS_Display(digit_B, digit_A);

  	  HAL_GPIO_TogglePin(LD2_GPIO_Port, LD2_Pin); // optional: proves code is running
